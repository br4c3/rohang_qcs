...
class PIDGuidanceNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('kp_final', 0.27)
        ...
        self.declare_parameter('xy_tol', 0.08)
    ...
    def approach(self, dt:float):
        ...
        vz_ned = self.get_descent_vz(alt)  if alt > 1.0 else self.pid_z.update(alt, dt)
        ...
        if self.z_aligned_gate:
            vel_ned_xy = np.array([vel_ned_full[0], vel_ned_full[1], 0.0])
