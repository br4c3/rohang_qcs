...
class Transformation(Node):
    def __init__(self):
        ...
        self.declare_parameter('cam_offset_body', [0.25, 0.0, 0.0])
    ...
    def publish_nan_target(self):
        out = PointStamped()
        out.header.stamp = self.get_clock().now().to_msg()
        out.header.frame_id = self.output_frame_id

        out.point.x = math.nan
        out.point.y = math.nan
        out.point.z = math.nan
